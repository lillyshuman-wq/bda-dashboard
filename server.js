...
const PORT         = 3000;
const REFRESH_MS   = 10 * 60 * 1000; // fetch HubSpot every 10 minutes

const REPS = [
  { name: 'Benny Terefenko',    id: '78010725' },
  { name: 'Cassidy Maisel',     id: '96182064' },
  { name: 'Cole Boyden',        id: '92871323' },
  { name: 'Ethan Gelman',       id: '95397173' },
  { name: 'Ewan Kim',           id: '93594620' },
  { name: 'Josh Mellott',       id: '95543468' },
  { name: 'Katelynn Patterson', id: '89923125' },
  { name: 'Rahmel Evans',       id: '93581117' },
  { name: 'Vishal Pagadala',    id: '96181947' },
];
...
async function fetchAllData() {
  ...
  // 4. Qual calls scheduled this month — Outbound, New Bookings Pipeline,
  // Qualification Call Scheduled stage, entered this month
  const qualMonthResults = await searchAll('deals', [
    { propertyName: 'business_development_lead', operator: 'IN', values: OWNER_IDS },
    { propertyName: 'pipeline', operator: 'EQ', value: 'default' },
    { propertyName: 'lead_source', operator: 'EQ', value: 'Outbound' },
    { propertyName: 'hs_v2_date_entered_appointmentscheduled', operator: 'GTE', value: monthStart },
  ], ['business_development_lead', 'hs_v2_date_entered_appointmentscheduled', 'pipeline', 'dealstage', 'lead_source']);
